...
# Images
imgBackground = pygame.image.load(
    'Resources/Project - GUI/background.png').convert()
imgDesign = pygame.image.load(
    'Resources/Project - GUI/design.png').convert_alpha()
imgIcon1 = pygame.image.load(
    'Resources/Project - GUI/icon1.png').convert_alpha()
imgIcon2 = pygame.image.load(
    'Resources/Project - GUI/icon2.png').convert_alpha()
imgIcon3 = pygame.image.load(
    'Resources/Project - GUI/icon3.png').convert_alpha()
imgIcon4 = pygame.image.load(
    'Resources/Project - GUI/icon4.png').convert_alpha()
imgIcon5 = pygame.image.load(
    'Resources/Project - GUI/icon5.png').convert_alpha()
imgShadow = pygame.image.load(
    'Resources/Project - GUI/shadow.png').convert_alpha()
imgToggleOn = pygame.image.load(
    'Resources/Project - GUI/toggleOn.png').convert_alpha()
imgToggleOff = pygame.image.load(
    'Resources/Project - GUI/toggleOff.png').convert_alpha()

# List of WindowPads
pads = [{"no": 1, "color": c['lightGreen'], "text": "Original", "icon": imgIcon2},
        {"no": 2, "color": c['lightOrange'],
            "text": "Gray Scale", "icon": imgIcon3},
...
def drawAll():
    w, h = 312, 301
    gapW, gapH = 72, 25
    drawWindowPad((484, 57, w, h),
                  pads[0]['color'], pads[0]['text'], pads[0]['icon'])
    drawWindowPad((484 + gapW + w, 57, w, h),
                  pads[1]['color'], pads[1]['text'], pads[1]['icon'])
    drawWindowPad((484, 57 + gapH + h, w, h),
                  pads[2]['color'], pads[2]['text'], pads[2]['icon'])
    drawWindowPad((484 + gapW + w, 57 + gapH + h, w, h),
                  pads[3]['color'], pads[3]['text'], pads[3]['icon'])
